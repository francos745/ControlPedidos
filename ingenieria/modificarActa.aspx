<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="modificarActa.aspx.vb" Inherits="ingenieria_modificarActa" %>
...
<body>
    ...
    <!-- El logotipo y el icono que despliega el menú se agrupan
       para mostrarlos mejor en los dispositivos móviles -->
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><strong>MODIFICAR ACTA</strong></a>         
        </div>
  ...
  <!-- Agrupar los enlaces de navegación, los formularios y cualquier
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <div class="text-center" >
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3" >
                         <div runat="server" id="lblAcepRechS" class="">
                            <strong><asp:Label ID="lblAcepRech" runat="server" Text=""></asp:Label></strong>
                        </div>
                    ...
                    <div class="col-sm-3" >
                         <div runat="server" id="lblEstadoS" class="">
                            <strong><asp:Label ID="lblEstado" runat="server" Text=""></asp:Label></strong>
                        </div>
                    </div>
                    <div class="col-sm-3" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                ...
                                <div class="btn-group" role="group">
                                    <input id="btnCambiar" type="button" value="Cambiar Acta" onfocus="escribir()"  data-target="#modalActas" class="btn btn-default btn-md"  runat="server" data-toggle="modal" data-backdrop="static" />
                                </div>
                                <div class="btn-group" role="group">
    ...
    <div class="row">
        ...
        <fieldset id="fsCombos" runat="server">
        ...
        <div class="col-sm-3" >
            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                ...
                <label for="nueva" class="control-label">Cantidad: </label>
                    <div class="controls" >
                        <asp:TextBox ID="txtCantidad" autocomplete="off" style="text-align:center;" runat="server" onkeyup="validarImporte();mascara(this)" onkeypress="ValidaSoloNumeros()" class="form-control input-md" AutoPostBack="false" placeholder=""></asp:TextBox>
                        <asp:Label ID="lblCantEq" runat="server" Text="" Font-Bold="True" Font-Size="X-Large" ></asp:Label>
                        <asp:Label ID="lblCantAux" runat="server" Text="" Font-Bold="True" Font-Size="X-Large" style="display:none;"></asp:Label>
            ...
            <div class="table-responsive" >
                ...
                <asp:GridView ID="dtgDetalle" runat="server" 
                    ...
                    <asp:SqlDataSource ID="Detalles" runat="server" ProviderName="System.Data.SqlClient" >
                         <SelectParameters>
                            <asp:ControlParameter ControlID="cmbCodigoActa" DefaultValue="ninguno" Name="CODIGO_ACTA" PropertyName="Text" Type="String" />
                        </SelectParameters>
    ...
    function validarImporte() {
        ...
        var lblCantAux = document.getElementById('<%= lblCantAux.ClientID %>').innerText;
        

        
        cantidad = (txtCantidad)*1;
        cantOriginal = (lblCantAux)*1;
        
       
        if (cantidad < cantOriginal) {
            document.getElementById("lblMensajeS").style = "";
            document.getElementById("lblMensajeS").className = "alert alert-danger";
            document.getElementById('<%= lblMensaje.ClientID %>').innerHTML = "No se puede ingresar una cantidad menor a " + Math.round(cantOriginal * 100) / 100 + " ";
            document.getElementById("btnAgregar").className = "btn btn-vitalicia btn-md disabled";
        }
        else {
            document.getElementById('<%= lblMensaje.ClientID %>').innerHTML = "";
                document.getElementById("lblMensajeS").style = "display:none;";
                document.getElementById("lblMensajeS").className = "alert alert-info";
                document.getElementById("btnAgregar").className = "btn btn-vitalicia btn-md";
   ...
   function escribir() {
           var codacta;
           var fecha;
           codacta = document.getElementById('<%= txtCodigoActaAux.ClientID %>').value;
           fecha = document.getElementById('<%= txtFechaAux.ClientID %>').value;
           document.getElementById('<%= txtCodigoActa.ClientID %>').value = codacta;           
                    ...
                    <div class="control-group">
                        <div class="row">
                            <div class="col-sm-6" >
                                <label for="nueva" class="control-label">Código de Acta:</label>
                                <div class="controls">
                                     <asp:TextBox ID="txtCodigoActa" maxlength="25"  runat="server" class="form-control input-md" placeholder="Codigo de Acta"></asp:TextBox>                                    
                                </div>
                            </div> 
                            <div class="col-sm-6" >
