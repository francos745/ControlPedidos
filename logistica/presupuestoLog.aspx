<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="presupuestoLog.aspx.vb" Inherits="logistica_presupuestoLog" %>
...
<body>
  ...
  <!-- Agrupar los enlaces de navegación, los formularios y cualquier
    ...
    <div id="contTitulos" runat="server">
       ...
       <div class="row">
        <div class="col-sm-12">
            <h6><span class="label alert-info" id="lblDocsFarS" runat="server"><strong><asp:Label ID="lblDetalleAct" runat="server" Text=""></asp:Label></strong></span></h6>
                ...
                <asp:GridView ID="dtgActividades" runat="server" 
                    ...
                    <Columns>
                       ...
                       <asp:BoundField DataField="MATERIAL" HeaderText="MATERIAL" ReadOnly="True" Visible="true" SortExpression="ID" />
                        ...
                        <asp:BoundField DataField="CANT_ACTAS_P" HeaderText="CANTTIDAD ACTAS" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />

                        <asp:BoundField DataField="CANT_DEV_P" HeaderText="CANTIDAD DEVUELTA" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />

                        <asp:BoundField DataField="CANT_PRESUP_ACTAS_P" HeaderText="CANTIDAD PRESUPUESTADA + ACTAS + DEVUELTAS" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />
                        ...
                        <asp:BoundField DataField="CANT_SOL_A" HeaderText="ANTERIORES SIN APROBAR"  SortExpression="SOL" DataFormatString="{0:N}" />
                        ...
                        <asp:BoundField DataField="CANT_ACTAS_A" HeaderText="CANTTIDAD ACTAS" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />
                        
                        <asp:BoundField DataField="CANT_DEV_A" HeaderText="CANTIDAD DEVUELTA" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />
                        
                        <asp:BoundField DataField="CANT_PRESUP_ACTAS_A" HeaderText="CANTIDAD PRESUPUESTADA + ACTAS + DEVUELTAS" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />
        ...
        <div class="col-sm-12">            
            <h6><span class="label alert-info" id="Span1" runat="server"><strong><asp:Label ID="lblActividadDetalle" runat="server" Text=""></asp:Label></strong></span></h6>
        ...
        <div class="col-sm-12">            
            <h6><span class="label alert-info" id="Span2" runat="server"><strong><asp:Label ID="lblSolicitudDesc" runat="server" Text=""></asp:Label></strong></span></h6>
        ...
        <div class="col-sm-12">
            <h6><span class="label alert-info" id="Span3" runat="server"><strong><asp:Label ID="lblSolicitudDesc2" runat="server" Text=""></asp:Label></strong></span></h6>
