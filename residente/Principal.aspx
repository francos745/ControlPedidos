<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="Principal.aspx.vb" Inherits="Principal" %>
    ...
    <div class="container">
        <form class="form-horizontal" role="form" runat="server">
            ...
            <div class="text-center" >
                ...
                <h3 class="text-center">SOLICITUD DE PEDIDO DE MATERIALES</h3>
                <h4 class="text-center"><span class="hidden-xs">PÁGINA PRINCIPAL DE RESIDENTES DE OBRA</span></h4>
            ...
            <fieldset id="fsFormulario" runat="server">
                <div class="row">
                    <div class="col-sm-6">
                       <asp:Button ID="btnNueva" runat="server" Text="Nueva Solicitud" class="btn btn-vitalicia btn-lg btn-block" />
                    </div>
                    <div class="col-sm-6">
                       <h3><span class="hidden-xs">Generar una nueva solicitud de materiales.</span></h3> 
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h3><span class="hidden-xs">Verificar las solicitudes aprobadas por Ingeniería.</span></h3> 
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                       <h3><span class="hidden-xs">Verificar las solicitudes realizadas. </span></h3>
                    </div>
                </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                       <h3><span class="hidden-xs">Verificar las solicitudes rechazadas por Ingeniería. </span></h3>
                    </div>
                </div> 
        
                <div class="row">
                    <div class="col-sm-6">
                        <asp:Button ID="btnMatRechazado" runat="server" Text="Materiales Rechazados" class="btn btn-vitalicia btn-lg btn-block" />
                    </div>
                    <div class="col-sm-6">
                       <h3><span class="hidden-xs">Verificar los materiales rechazados por Ingeniería.</span></h3> 
                    </div>
                </div> 

                <div class="row">
                    <div class="col-sm-6">
                        <asp:Button ID="btnPresup" runat="server" Text="Presupuesto" class="btn btn-vitalicia btn-lg btn-block" />
                    </div>
                    <div class="col-sm-6">
