<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="Ingreso.aspx.vb" Inherits="ingenieria_Ingreso" %>
		...
		<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-header text-center" >
                    ...
                    <h3 class="text-center">INGRESO DE INGENIERÍA</h3>
                    <h4 class="text-center">VERIFICACIÓN DE PEDIDO DE MATERIALES</h4>
				</div>
