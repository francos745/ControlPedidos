<%@ Page Language="VB" AutoEventWireup="false" CodeFile="precioUnitario.aspx.vb" Inherits="ingenieria_precioUnitario" %>
                        ...
                        <div class="col-sm-4" >
                         ...
                         <div class="col-sm-4" >
                            <div class="control-group">
                                ...
                                <div class="controls" style="text-align:left;">
                                    <asp:DropDownList ID="cmbActividad" runat="server" class="mySelect" Width="100%"></asp:DropDownList>
            ...
            $('input[name="txtFecha"]').daterangepicker(
      {
          ...
          singleDatePicker: true
            ...
            function llenarComboProyectos() {
                ...
                $.ajax({
                    type: "POST",
                    url: "precioUnitario.aspx/llenarComboProyectos",
                    data: "{}",
             ...
             //funcion para llenar el combo box de actividades
            function llenarComboActividades() {
                var proyecto = $('#<%= cmbProyecto.ClientID %>').val();
                $("#cmbActividad").empty().append('');
                $.ajax({
                    type: "POST",
                    url: "precioUnitario.aspx/llenarComboActividades",
                    ...
                    success: function (response) {
                        ...
                        $.each(response.d, function () {
                            ...
                            if (count == 0) {
                                $('#cmbActividad').append($("<option selected></option>").val(this['Value']).html(this['Text']));
                            } else {
                                $('#cmbActividad').append($("<option></option>").val(this['Value']).html(this['Text']));
                            }
                            count++;
                        });
            ...
            $('#cmbActividad').on('change', function () {
                mostrarCantidad();
                mostrarUM();
                llenarTablaMateriales();
                llenarTablaDetalles("NA",'NA');
             ...
             function llenarTablaMateriales() {
                 var actividad = $('#<%= cmbActividad.ClientID %>').val();
                ...
                $.ajax({
                    type: "POST",
                    url: "precioUnitario.aspx/obtenerTablaMateriales",
            ...
            $('#dtgMateriales tbody').on('click', 'span.edit', function () {
                ...
                llenarTablaDetalles(data[1],data[2]);
                llenarTablaSolicitudes("NA");
                llenarTablaActas("NA");
            });
             ...
             function llenarTablaDetalles(material,nomMaterial) {
                 var proyecto = $('#<%= cmbProyecto.ClientID %>').val();
                 document.getElementById('<%= lblDetalle.ClientID %>').innerHTML = "Detalles del material: " + nomMaterial;
                ...
                $.ajax({
                    type: "POST",
                    url: "precioUnitario.aspx/obtenerTablaDetalles",
                    ...
                    success: function (response) {
                        ...
                        $.each(response.d, function () {
                            ...
                            c = parseFloat(this['c7']);
                            d = parseFloat(this['c8']);
                            e = a + b + c + d;
             ...
             function llenarTablaSolicitudes(codigoSol) {
                ...
                $.ajax({
                    type: "POST",
                    url: "precioUnitario.aspx/obtenerTablaSolicitudes",
             ...
             function llenarTablaActas(codigoSol) {
                ...
                $.ajax({
                    type: "POST",
                    url: "precioUnitario.aspx/obtenerTablaActas",
                    data: '{codigoSolicitud: "' + codigoSol + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
            ...
            //FUNCION QUE MUESTRA LA UNIDAD DE MEDIDA
            function mostrarUM() {
                var actividad = $('#<%= cmbActividad.ClientID %>').val();
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "precioUnitario.aspx/verUnidadMedida",
                    data: '{actividad: "' + actividad + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        var texto = response.d;
                        document.getElementById('<%= lblUm.ClientID %>').innerHTML = texto;
            ...
            function mostrarCantidad() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "precioUnitario.aspx/verCantidad",
                    data: '{actividad: "' + actividad + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        var texto = response.d;
                        document.getElementById('<%= lblCantidad.ClientID %>').innerHTML = texto;
