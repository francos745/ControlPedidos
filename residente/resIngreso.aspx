<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="resIngreso.aspx.vb" Inherits="resIngreso" %>
		...
		<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-header text-center" >
                    ...
                    <h3 class="text-center">INGRESO DE RESIDENTES  DE OBRA</h3>
                    <h4 class="text-center">SOLICITUD DE PEDIDO DE MATERIALES</h4>
