<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="solicitudesRechazadas.aspx.vb" Inherits="ingenieria_solicitudesRechazadas" %>
    ...
    <!-- El logotipo y el icono que despliega el menú se agrupan
       para mostrarlos mejor en los dispositivos móviles -->
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><strong>SOLICITUDES RECHAZADAS</strong></a>         
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Seguro que desea mover la Solicitud a cursadas?</p>
