<%@ Page culture="es-MX" UICulture="es-MX"  Language="VB" AutoEventWireup="false" CodeFile="materialesRechazados.aspx.vb" Inherits="ingenieria_materialesRechazados" %>
            ...
            <div class="table-responsive" >
                ...
                <asp:GridView ID="dtgDetalle" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CANT_ACTAS_P" HeaderText="CANTIDAD EN ACTAS" ReadOnly="True" SortExpression="SOL" DataFormatString="{0:N}" />
                        ...
                        <asp:BoundField DataField="ARTICULO" HeaderText="ARaTICULO" ReadOnly="True" SortExpression="ART" />   
