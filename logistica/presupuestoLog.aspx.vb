Partial Class logistica_presupuestoLog
    ...
    Sub llenarTablaActividades()
        ...
        query = "SELECT * FROM SOL_PEDIDOS.PEDIDOS.PRECIO_UNITARIO_LOG WHERE ACTIVIDAD=@CODIGO_ACTIVIDAD"
    ...
    Sub llenarTablaDetalleActividades()
        ...
        query = "SELECT * FROM SOL_PEDIDOS.PEDIDOS.PRECIO_UNITARIO_LOG_DET WHERE MATERIAL=@DETALLE_ACTIVIDAD"
